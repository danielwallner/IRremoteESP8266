...
TEST(TestLowLevelSend, MarkFrequencyModulationAt38kHz) {
  ...
  EXPECT_EQ(
      "[On]13usecs[Off]13usecs[On]13usecs[Off]13usecs"
      "[On]13usecs[Off]13usecs[On]13usecs[Off]8usecs",
  ...
  EXPECT_EQ(4, irsend.mark(100));
  EXPECT_EQ(
      "[On]8usecs[Off]18usecs[On]8usecs[Off]18usecs"
      "[On]8usecs[Off]18usecs[On]8usecs[Off]13usecs",
      irsend.low_level_sequence);
...
TEST(TestLowLevelSend, MarkFrequencyModulationAt36_7kHz) {
  ...
  EXPECT_EQ(4, irsend.mark(100));
  EXPECT_EQ(
      "[On]13usecs[Off]14usecs[On]13usecs[Off]14usecs"
      "[On]13usecs[Off]14usecs[On]13usecs[Off]5usecs",
      irsend.low_level_sequence);
  ...
  EXPECT_EQ(4, irsend.mark(100));
  EXPECT_EQ(
      "[On]8usecs[Off]19usecs[On]8usecs[Off]19usecs"
      "[On]8usecs[Off]19usecs[On]8usecs[Off]10usecs",
      irsend.low_level_sequence);
...
TEST(TestLowLevelSend, MarkFrequencyModulationAt40kHz) {
  ...
  EXPECT_EQ(4, irsend.mark(100));
  EXPECT_EQ(
      "[On]12usecs[Off]13usecs[On]12usecs[Off]13usecs"
      "[On]12usecs[Off]13usecs[On]12usecs[Off]13usecs",
      irsend.low_level_sequence);
  ...
  EXPECT_EQ(4, irsend.mark(100));
  EXPECT_EQ(
      "[On]8usecs[Off]17usecs[On]8usecs[Off]17usecs"
      "[On]8usecs[Off]17usecs[On]8usecs[Off]17usecs",
      irsend.low_level_sequence);
